...
| [`codex`](skills/codex/) | Second-opinion consults via the Codex CLI (cross-model review), plus raster image generation/editing through Codex's built-in `image_gen` (gpt-image-2, ChatGPT plan, no API key) |
